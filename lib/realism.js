...
export function summarizeRealism(results, expectedRuns = 10) {
  ...
  return {
    ...
    pass: results.length === expectedRuns && partnerTurns === expectedRuns * 5 && roleConfusions === 0 && factContradictions === 0 && styleIssues === 0 && segmentationIssues === 0 && repetitionRate < 0.3 && personalityPass && segmentationPass,
  };
}
